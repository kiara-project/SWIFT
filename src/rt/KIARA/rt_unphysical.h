 ...
 *
 ******************************************************************************/
#ifndef SWIFT_RT_UNPHYSICAL_KIARA_H
#define SWIFT_RT_UNPHYSICAL_KIARA_H

/**
 * @file src/rt/KIARA/rt_unphysical.h
...
rt_check_unphysical_mass_fractions(struct part* restrict p) {
  ...
  if (hydro_get_mass(p) <= 0.f || p->rho <= 0.f) {
    ...
    p->rt_data.tchem.mass_fraction_HI = RT_KIARA_TINY_MASS_FRACTION;
    p->rt_data.tchem.mass_fraction_HII = RT_KIARA_TINY_MASS_FRACTION;
    p->rt_data.tchem.mass_fraction_HeI = RT_KIARA_TINY_MASS_FRACTION;
    p->rt_data.tchem.mass_fraction_HeII = RT_KIARA_TINY_MASS_FRACTION;
    p->rt_data.tchem.mass_fraction_HeIII = RT_KIARA_TINY_MASS_FRACTION;
    return;
  }
  ...
  p->rt_data.tchem.mass_fraction_HI =
      max(p->rt_data.tchem.mass_fraction_HI, RT_KIARA_TINY_MASS_FRACTION);
  p->rt_data.tchem.mass_fraction_HII =
      max(p->rt_data.tchem.mass_fraction_HII, RT_KIARA_TINY_MASS_FRACTION);
  p->rt_data.tchem.mass_fraction_HeI =
      max(p->rt_data.tchem.mass_fraction_HeI, RT_KIARA_TINY_MASS_FRACTION);
  p->rt_data.tchem.mass_fraction_HeII =
      max(p->rt_data.tchem.mass_fraction_HeII, RT_KIARA_TINY_MASS_FRACTION);
  p->rt_data.tchem.mass_fraction_HeIII =
      max(p->rt_data.tchem.mass_fraction_HeIII, RT_KIARA_TINY_MASS_FRACTION);
...
#endif /* SWIFT_RT_UNPHYSICAL_KIARA_H */
