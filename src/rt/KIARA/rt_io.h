 ...
 *
 ******************************************************************************/
#ifndef SWIFT_RT_IO_KIARA_H
#define SWIFT_RT_IO_KIARA_H

#define RT_LABELS_SIZE 10
#include "cooling_io.h"

/**
 * @file src/rt/KIARA/rt_io.h
 * @brief Main header file for KIARA M1 Closure radiative transfer
 * scheme IO routines.
 */
